    ...
    ui(new Ui::MainWindow)
{
    ...
    ui -> EnableSliderButton -> setStyleSheet("background-color: #FAFA5F; border-style: outset;");
    ui -> pushButtonSetting -> setStyleSheet("background-color: #FAAF5F; border-style: outset;");
    ui -> pushButtonOpenCloseCamera -> setStyleSheet("background-color: #5F6DFA; border-style: outset;");
